...
from PyQt6.QtWidgets import QApplication, QLabel, QVBoxLayout, QLineEdit, QPushButton, QMessageBox
...
class GuessNumber(QWidget):
    def __init__(self):
        ...
        self.submit_button = QPushButton("Ок", self)
    ...
    def check_guess(self):
        ...
        if guess == self.number_to_guess:
            ...
            if self.attempts_left == 0:
                QMessageBox.information(self, "Поражение", f"Вы не угадали! Загаданное число: {self.number_to_guess}")
                self.close()
            else:
