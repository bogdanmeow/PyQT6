...
import sqlite3
from sequrity import TerminalApp
...
class True_open_in(QMainWindow):
    def __init__(self):
        ...
        self.label.setText("Сотрудник зарегистрирован!\n Проходите!")
...
class False_open_in(QMainWindow):
    ...
    def initUI(self):
        ...
        self.label = QLabel(self)
        self.label.setText("Сотрудник не зарегистрирован!\n Хотите оформить временный пропуск?")
...
class CheckDataWindow(QWidget):
    def __init__(self):
        ...
        self.number_label = QLabel("Номер пропуска:")
    ...
    def check_data_in(self):
        ...
        # Выполнение запроса на поиск данных в базе данных
